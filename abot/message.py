        ...
        for i in iterable:
            if isinstance(i[0], list):#
                ...
                try:
                    ...
                    raise TypeError("Неверно указан формат. В корне списка должны лежать строки, а в строках кнопки, состоящие из 2-х эл-ов: [названия, сообщения]. Сообщением может быть url или, если вам нужен calllback, то словарём из 1-го значения с любым ключом.") from index_err
